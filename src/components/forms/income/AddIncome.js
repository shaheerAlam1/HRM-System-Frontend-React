    ...
    return (
      <>
        <Row>
          <Col md="4">
            <Card border="danger" >
              <Card.Header style={{ backgroundColor: "#DC3545", color: "white" }}>Add Income</Card.Header>
              <Card.Body>
          ...
          <Col md="8">
            <Card border="danger" >
              <Card.Header style={{ backgroundColor: "#DC3545", color: "white" }}>Income List</Card.Header>
              <Card.Body>
