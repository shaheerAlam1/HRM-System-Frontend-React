...
class PostalDispatch extends Component {
  render() {
    return (
      <>
        <Row>
          <Col md="4">
            <Card border="primary" >
              <Card.Header style={{ backgroundColor: "#007BFF", color: "white" }}>Add Postal Dispatch</Card.Header>
              <Card.Body>
          ...
          <Col md="8">
            <Card border="primary" >
              <Card.Header style={{ backgroundColor: "#007BFF", color: "white" }}>Postal Dispatch List</Card.Header>
              <Card.Body>
